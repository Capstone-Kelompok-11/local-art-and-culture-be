...
func (m *MockICreatorRepository) CreateCreator(arg0 *request.Creator) (response.Creators, error) {
	m.ctrl.T.Helper()
...
func (m *MockICreatorRepository) GetAllCreator(arg0 request.Creator) ([]response.Creators, error) {
	m.ctrl.T.Helper()
...
func (mr *MockICreatorRepositoryMockRecorder) GetAllCreator(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCreator", reflect.TypeOf((*MockICreatorRepository)(nil).GetAllCreator), arg0)  
}

// GetCreator mocks base method.
func (m *MockICreatorRepository) GetCreator(arg0 string) (response.Creators, error) {
	m.ctrl.T.Helper()
