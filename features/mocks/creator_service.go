...
func (m *MockICreatorService) CreateCreator(arg0 *request.Creator) (response.Creators, error) {
	m.ctrl.T.Helper()
...
func (m *MockICreatorService) GetAllCreator(arg0 request.Creator) ([]response.Creators, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCreator", arg0)
	ret0, _ := ret[0].([]response.Creators)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockICreatorServiceMockRecorder) GetAllCreator(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCreator", reflect.TypeOf((*MockICreatorService)(nil).GetAllCreator), arg0)     
}

// GetAllCreatorByRole mocks base method.
func (m *MockICreatorService) GetAllCreatorByRole(arg0 request.Creator) ([]response.Creators, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCreatorByRole", arg0)
	ret0, _ := ret[0].([]response.Creators)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllCreatorByRole indicates an expected call of GetAllCreatorByRole.
func (mr *MockICreatorServiceMockRecorder) GetAllCreatorByRole(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCreatorByRole", reflect.TypeOf((*MockICreatorService)(nil).GetAllCreatorByRole), arg0)
}

// GetCreator mocks base method.
func (m *MockICreatorService) GetCreator(arg0 string) (response.Creators, error) {
	m.ctrl.T.Helper()
