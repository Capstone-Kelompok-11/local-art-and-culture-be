...
// GetAllAvailableEvent mocks base method.
func (m *MockIEventRepository) GetAllAvailableEvent(arg0, arg1, arg2 string, arg3, arg4 int) ([]response.Event, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllAvailableEvent", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].([]response.Event)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
...
// GetAllAvailableEvent indicates an expected call of GetAllAvailableEvent.
func (mr *MockIEventRepositoryMockRecorder) GetAllAvailableEvent(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllAvailableEvent", reflect.TypeOf((*MockIEventRepository)(nil).GetAllAvailableEvent), arg0, arg1, arg2, arg3, arg4)
}
