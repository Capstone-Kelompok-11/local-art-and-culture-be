...
func (m *MockIRoleRepository) FindByName(arg0 string) (*models.Role, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRoleRepositoryMockRecorder) FindByName(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByName", reflect.TypeOf((*MockIRoleRepository)(nil).FindByName), arg0)
}

// GetAllRole mocks base method.
func (m *MockIRoleRepository) GetAllRole(arg0 string) ([]response.Role, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllRole", arg0)
	ret0, _ := ret[0].([]response.Role)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIRoleRepositoryMockRecorder) GetAllRole(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllRole", reflect.TypeOf((*MockIRoleRepository)(nil).GetAllRole), arg0)
}
