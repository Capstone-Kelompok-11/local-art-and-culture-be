...
func (m *MockIRoleService) GetAllRole(arg0 string) ([]response.Role, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRoleServiceMockRecorder) GetAllRole(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllRole", reflect.TypeOf((*MockIRoleService)(nil).GetAllRole), arg0)
}
