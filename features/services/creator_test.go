...
// 	mockCreatorRepo.EXPECT().GetAllCreator().Return([]response.UserCreatorResponse{
// 		{
// 			Id: 1, 
// 			FirstName: "pudu",
// 			LastName: "lee",
...
// 	assert.NoError(t, err)
// 	assert.Equal(t, []response.UserCreatorResponse{
// 		{
// 			Id: 1, 
// 			FirstName: "pudu",
// 			LastName: "lee",
...
// 	mockCreatorRepo.EXPECT().GetCreator(gomock.Any()).Return(response.UserCreatorResponse{}, nil)

// 	result, err := creatorService.GetCreator("pudu")

// 	assert.NoError(t, err)
// 	assert.Equal(t, response.UserCreatorResponse{}, result)
// }
...
// 	mockCreatorRepo.EXPECT().GetCreator(gomock.Any()).Return(response.UserCreatorResponse{}, someError)
